...
# - have been in bed for at least 120 ticks (100 is regular sleep time), OR
# - are experiencing insomnia, OR
# - are in the nether or the end

# a player meets none of the previous criteria if:
# - they have been in bed for less than 120 ticks, AND
...
execute unless entity @a[scores={av-insomnia-slep=..119,av-insomnia=0},nbt={Dimension:0}] run time set 0